/*---------------------------------------------------------------------------*/
/* File: FrameL.h                             Last update:     May 14, 2005  */
/*                                                                           */
...
FrEvent *FrEventAddParam(FrEvent *event,  char *name,  float value);
...
FrFileH* FrFileBreakName(char *fullName, FrFileH *next);
...
FrVect *FrFileIGetEventSNRV(FrFile *iFile, char *tag, double tStart, 
                           double length, double aMin, double aMax, int nData);
...
FrVect *FrFileIGetSimEventSNRV(FrFile *iFile, char *tag, double tStart, 
                           double length, double aMin, double aMax, int nData);
